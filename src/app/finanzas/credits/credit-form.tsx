...
export default function CreditForm({ inputStyles }: { inputStyles: string }) {
  const [state, formAction] = useActionState(addCredit, IDLE_STATE);
    ...
    <form ref={formRef} action={formAction} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 md:gap-6">
        ...
        <div className="flex items-end mt-2 md:mt-0">
          <SubmitButton pendingText="Registrando…" className="w-full py-4 md:py-3.5 rounded-2xl text-[10px] shadow-xl">
